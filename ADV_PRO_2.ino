/*
  ...
  Displaying the 4 arithmetic operation i.e. +, -, power, % (modulo) using the 4*4 keypad and LCD screen.
  Outputs Shown On - LCD Screen.
  Libraries Used - LiquidCrystal.h, Keypad.h
  This code has the Advanced Version.
...
void CalculateResult()
{
  ...
  if (action=='*') //loop for power
    Number = (pow(Num1,Num2)+1);

  if (action=='%') //loop for modulo
    Number = Num1%Num2; 
}
